          ...
          <>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "24px" }}>
              {[
                ...
                { name: "Sentry", desc: "Error monitoring for frontend and serverless functions. Captures unhandled errors with full context so issues are caught before Brad notices them.", url: "https://sentry.io", cost: "Free tier" },                <Card key={tool.name} style={{ padding: "16px" }}>
                { name: "Linktree", desc: "Bio link hub for TikTok. Routes all traffic from @progressivehealth bio link through Amazon Attribution tags to the Lipitrex listing. Do not modify links without coordinating with Josh.", url: "https://linktr.ee", cost: "Free" },                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ flex: 1 }}>
