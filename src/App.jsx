...
${type === 'video' ? `Full script timed to ${persona.length}. The SCRIPT section contains only clean spoken dialogue — no bracketed directions, no timestamps, no markdown. Write the body as one continuous flowing paragraph with natural connective tissue. Never list ingredients as specs. Write Soft, Medium, and Hard CTA options as separate labeled paragraphs of clean spoken words only. The viewer should feel like they're overhearing someone tell a friend, not watching someone deliver information.` : '3 slides maximum. Each slide uses exactly these labels: Headline Text: [the actual headline] Body Text: [the actual body copy only — no formatting notes, no production instructions, no placeholder text. Write the final words that will appear on the slide exactly as they should be read by a viewer.] Visual Direction: [production notes for HeyGen go here only] Slide 1: hook. Slide 2: education/value with actual checklist items written out in full. Slide 3: CTA with soft product mention.'}
